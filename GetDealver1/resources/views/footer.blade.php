{{--  <section id="footer" class="section footer">
  ...
  <a href="#header" class="scrollup" style="border-radius: 32px"><i class="fa fa-chevron-up"></i></a> --}}
  {{-- <footer class="page-footer font-small mdb-color lighten-3 pt-4" style="background: darkslateblue;">
   ...
   <!--    </div> -->
    ...
    <!-- Copyright -->
    <div class="footer-copyright text-center py-3" style="background: midnightblue;color:white">© 2018 Copyright:
      GETDEAL-TEAM
    </div>
    <!-- Copyright -->
